  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        console.error("Error fetching Be Right Back products:", error);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="pt-33 px-4 md:px-0 max-w-screen-2xl mx-auto">
      ...
      {loading ? (
        ...
        <p className="text-center text-gray-500">No Be Right Back products available.</p>
      ) : (
